...
const ScreenHeader: React.FC<ScreenHeaderProps> = (props) => {
  ...
  return (
    <View style={styles.container}>
      <NavArrowDown onPress={props.onPress} color={DARKCOLORS.textColor_1} width={35} height={35}/>
			<Text style={styles.title}>{props.title}</Text>
      { props.iconRight && <Heart onPress={handleLoveIcon} color={isLove ?'#F40824' : DARKCOLORS.textColor_1 } width={30} height={30}/>}
    </View>
  )
}
