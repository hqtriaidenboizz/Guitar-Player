    ...
    <KeyboardAvoidWrapper>
      ...
      <View style={{marginHorizontal: 30, display:'flex', gap: 20}}>
        ...
        <CustomInput 
          ...
          icon={
            <Icon onPress={() => setHidePassword(!hidePassword)} name={hidePassword ? 'eye-outline' : 'eye-off-outline'} size={20} color= {DARKCOLORS.textColor_1}/>
          }/>
      </View>
      <View style={{marginTop: 40,marginHorizontal: 30, display:'flex', gap: 20}}>
